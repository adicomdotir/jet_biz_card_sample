...
import ir.adicom.jedbizcard.feature_users.presentation.Screen
import ir.adicom.jedbizcard.feature_users.presentation.home.components.UserItem
    ...
    Scaffold(
        ...
        content = { innerPadding ->
            HomeContent(
                ...
                onEditUser = {
                    navController.navigate(route = Screen.Edit.passId(it))
                },
                users = state.users
            )
        }
